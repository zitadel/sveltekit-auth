...
hero:
  name: SvelteKitAuth
  text: Authentication for SvelteKit!
  ...
  actions:
    ...
    - theme: alt
      text: GitHub
      link: https://github.com/zitadel/sveltekit-auth

features:
  - title: OAuth
    details: Effortlessly connect your SvelteKit application with Google, GitHub, Azure and countless others.
  ...
  - title: Made for SvelteKit
    details: Deep integrations with the SvelteKit framework.
