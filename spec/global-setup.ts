 ...
 * `webServer` starts.
 *
 * Installs playground dependencies and then runs a production build
 * of the playground. The install step is critical in CI environments
 * where root `npm ci` does NOT cascade into the playground (the
 * playground is not a workspace).
 *
